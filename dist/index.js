...
function Card(props) {
  ...
  return /* @__PURE__ */ jsxs4("div", __spreadProps(__spreadValues({ className: classes }, rest), { children: [
    image && /* @__PURE__ */ jsx8("img", { src: image, alt: imageAlt != null ? imageAlt : "", style: imageHeight ? { height: `${imageHeight}px` } : void 0, className: "guwmi-card-image" }),
...
function Table(props) {
  ...
  return /* @__PURE__ */ jsxs18("div", __spreadProps(__spreadValues({ className: classes }, rest), { children: [
    ...
    /* @__PURE__ */ jsx40("div", { className: "guwmi-table-content", children: /* @__PURE__ */ jsx40("table", { cellPadding: 0, cellSpacing: 0, tabIndex: -1, children: skeleton ? /* @__PURE__ */ jsxs18(Fragment2, { children: [
